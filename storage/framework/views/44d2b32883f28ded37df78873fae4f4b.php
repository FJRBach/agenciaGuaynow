...
<div class="card mt-4 mb-4 p-3">    
            ...
            <tbody>
                <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="row-<?php echo e($loop->index); ?>" class="<?php echo e($loop->index % 2 == 0 ? 'table-primary' : 'table-secondary'); ?>">
                        <td class="text-center"><?php echo e($sucursal->codigoSucursal); ?></td>
                        <td class="text-center"><?php echo e($sucursal->nombreSucursal); ?></td>
                        <td class="text-center"><?php echo e($sucursal->direccion); ?> <?php echo e($sucursal->noExt); ?></td>
                        <td class="text-center"><?php echo e($sucursal->ciudad); ?></td>
                        <td class="text-center"><?php echo e($sucursal->provincia); ?></td>
                        <td class="text-center"><?php echo e($sucursal->estado ? 'DISPONIBLE' : 'NO DISPONIBLE'); ?></td>
                        <td class="text-center">
                            <button type="button" class="btn btn-edit" style="font-size: 16px;" data-bs-toggle="modal" data-bs-target="#modalModificarSucursal" data-id="<?php echo e($sucursal->IDSucursal); ?>">
    ...
    <?php echo $__env->make('catalogos.sucursalAgregarGet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make("components.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\agenciaViajes\resources\views/catalogos/sucursalGet.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection("content"); ?>
    ...
    <div class="container txt-expand">
        ...
        <div class="table-responsive txt-expand">
            <table class="table table-bordered" id="maintableC">
                ...
                <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr id="row-<?php echo e($loop->index); ?>" class="<?php echo e($loop->index % 2 == 0 ? 'table-primary' : 'table-secondary'); ?>">
                        <td class="text-center"><?php echo e($cliente->NIFCliente); ?></td>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-edit" data-bs-toggle="modal" data-bs-target="#modalCliente" data-id="<?php echo e($cliente->NIFCliente); ?>">
            ...
            <?php echo $__env->make('catalogos.clientesAgregarGet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make("components.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\agenciaViajes\resources\views/catalogos/clientesGet.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection("content"); ?>
                    ...
                    <tr id="row-<?php echo e($loop->index); ?>" class="<?php echo e($loop->index % 2 == 0 ? 'table-primary' : 'table-secondary'); ?>">
                        <td class="text-center">
                            <div style="display: flex; align-items: center; justify-content: center;">
                                <span><?php echo e($vuelo->IDVuelo); ?></span>
                            </div>
                        </td>
                        <td class="text-center"><?php echo e(date('d-m-Y H:i', strtotime($vuelo->fechaHraSalida))); ?></td>
                        <td class="text-center"><?php echo e(date('d-m-Y H:i', strtotime($vuelo->fechaHraLlegada))); ?></td>
                        <td class="text-center">
                            <button type="button" class="btn btn-edit" data-bs-toggle="modal" data-bs-target="#modalVuelo" data-id="<?php echo e($vuelo->IDVuelo); ?>">
                                <img src="<?php echo e(asset('editar.png')); ?>" alt="MOD" style="width: 24px; height: 24px; margin-right: 5px;">
                            </button>
                        </td>
                        <td class="text-center"><?php echo e($vuelo->origen); ?></td>
                        <td class="text-center"><?php echo e($vuelo->destino); ?></td>
                        <td class="text-center"><?php echo e($vuelo->plazasDisponiblesTotales); ?></td>
                    </tr>
    ...
    <?php echo $__env->make('catalogos.vuelosAgregarGet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make("components.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\agenciaViajes\resources\views/catalogos/vuelosGet.blade.php ENDPATH**/ ?>
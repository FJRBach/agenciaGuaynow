...
<?php endif; ?>
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-600"><?php echo e(__('Mantener sesión iniciada')); ?></span>
                </label>
            </div>
...
<?php endif; ?>
    ...
    <div class="auth-card">
        ...
        <div class="mt-4">
            <a href="<?php echo e(route('register')); ?>" class="text-sm text-gray-700 underline">No tienes una cuenta? Regístrate</a>
        </div>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\agenciaViajes\resources\views/auth/login.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection("content"); ?>
    ...
    <form id="reservacionForm" action="<?php echo e(url('/movimientos/reservaciones/agregar')); ?>" method="POST" class="container" style="font-size: 21px;">
        <?php echo csrf_field(); ?>
        <br>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="cliente" name="NIFCliente" required style="font-size: 20px;">
                        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cliente->NIFCliente); ?>"><?php echo e($cliente->nombre); ?></option>
        ...
        <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="IDVuelo" name="IDVuelo" style="font-size: 20px;">
                            ...
                            <?php $__currentLoopData = $vuelos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vuelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($vuelo->IDVuelo); ?>" data-origen="<?php echo e($vuelo->origen); ?>" data-destino="<?php echo e($vuelo->destino); ?>" style="font-size: 20px;">
                            <strong>Vuelo <?php echo e($vuelo->IDVuelo); ?>:</strong> <?php echo e($vuelo->origen); ?> / <?php echo e($vuelo->destino); ?>
            ...
            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="hotel" name="IDHotel" style="font-size: 20px;">
                                ...
                                <?php $__currentLoopData = $hoteles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($hotel->IDHotel); ?>"><?php echo e($hotel->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="regimenHospedaje" name="IDRegimenHospedaje" style="font-size: 20px;">
                                ...
                                <?php $__currentLoopData = $regimenesHospedaje; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $regimen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($regimen->IDRegimenH); ?>"><?php echo e($regimen->descripcionRegimen); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group text-center">
                    ...
                    <img src="<?php echo e(asset('save.png')); ?>" alt="MOD" >    
                    </button>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var clasesVuelo = <?php echo json_encode($clasesVuelo, 15, 512) ?>;
    var vuelos = <?php echo json_encode($vuelos, 15, 512) ?>;
...
<?php echo $__env->make("components.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\agenciaViajes\resources\views/movimientos/reservacionesAgregarGet.blade.php ENDPATH**/ ?>